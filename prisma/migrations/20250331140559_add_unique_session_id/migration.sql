/*
  ...
  - A unique constraint covering the columns `[sessionId]` on the table `Stripe` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX "Stripe_sessionId_key" ON "Stripe"("sessionId");
