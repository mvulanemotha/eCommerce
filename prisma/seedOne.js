...
async function main() {
  ...
  await prisma.image.create({
    data: { url: "/images/laptop.jpg", productId: product1.id },
  });
  await prisma.image.create({
    data: { url: "/images/smartphone.jpg", productId: product2.id },
  });
  await prisma.image.create({
    data: { url: "/images/headphones.jpg", productId: product3.id },
  });
